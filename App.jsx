...
function App() {
  ...
  return (
    <main>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '0 0 14px' }}>
        <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f4d6bc', color: '#2a0d12', fontWeight: 700 }} onClick={() => setShowFilters(current => !current)}>Filter</button>
        <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f4d6bc', color: '#2a0d12', fontWeight: 700 }} onClick={() => setShowSort(current => !current)}>Sort</button>
      </section>
